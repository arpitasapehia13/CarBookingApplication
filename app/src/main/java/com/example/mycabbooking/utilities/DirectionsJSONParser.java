package com.example.mycabbooking.utilities;
            ...
            for (int i = 0; i < jRoutes.length(); i++) {
                ...
                for (int j = 0; j < jLegs.length(); j++) {
                    ...
                    for (int k = 0; k < jSteps.length(); k++) {
                        /** Parse distance*/
                        Integer distanceInMeter = (Integer) ((JSONObject) ((JSONObject) jSteps.get(k)).get("distance")).get("value");
                        this.totalDistanceInMeters += distanceInMeter;
